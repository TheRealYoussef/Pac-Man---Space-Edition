...
private:
	...
	std::vector <TextureSprite> normal_state_images;

	//sf::texture and sf::sprite of the buttons in their selected state
	std::vector <TextureSprite> selected_state_images;
	...
	std::vector < std::vector <FUNCTIONS_0> > functions_0;

	//The functions of the buttons if they are pressed (1 input argument which is sf::RenderWindow &)
	std::vector < std::vector <FUNCTIONS_1> > functions_1;
	...
	void readFile(std::ifstream & file, std::vector <TextureSprite> & images, const int & index);
	...
	void setOriginAndPosition(std::vector <TextureSprite> & images, const int & index);
	...
	//Fills the vectors of functions with NULL
	void fillFunctionsNull(const int & index);
	...
	void scaleButton(std::vector <TextureSprite> & images);
...
public:
	...
	//Set what the button of index button_index does if it is pressed
	//void (*function)(): function name which is void and has 1 input argument which is sf::RenderWindow &
	//Put & followed by the function name only
	//A button can have as many functions as the user wishes
	void setFunction(const int & button_index, void(*function)(sf::RenderWindow & window));
